...
function Feature({
  ...
  let newEndEducation = new Date()

  if (endEducation) {
    newEndEducation = new Date(endEducation)
  }

  const distance = intervalToDuration({
    start: new Date(startEducation),
    end: newEndEducation,
  })
  const distancePeriod = `${distance.years} years ${distance.months} months`
